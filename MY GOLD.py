...
gold = pd.read_csv("https://github.com/HEMANT2008/Assignments-Dataset/files/10038702/Gold_data.csv")
...
if chart == 'Home page':
    ...
    image6 = Image.open(r"C:\Users\AMOL SHINDE\OneDrive\Desktop\hemant gold\hemant gold\img_7.png")
    st.image(image6)
